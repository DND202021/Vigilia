...
1. **Devices not visible on floor plan**: When viewing a floor plan, the placed devices are not showing up on the map.
...
1. Check that DeviceStatusOverlay or similar component is properly rendering device markers on the floor plan
